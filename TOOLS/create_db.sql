...
create table fundamentals(date date, sec_file char(24), sec_name varchar(100), sec_industry varchar(100), sic_code integer, total_assets integer, current_assets integer, cash integer, eps_basic float, eps_diluted float);
